<h1><i class="fa fa-road"></i> Milestones <small>All Milestones</small></h1>
	...
	<div class="col-md-8 col-md-pull-4">
		...
		<div class="list-group">
			<?php foreach ($milestones as $milestone): ?>
				<a href="<?php echo $this->webroot; ?>milestones/view/<?php echo $milestone['Milestone']['id']; ?>" class="list-group-item">
					<p class="list-group-item-text"><i class="fa fa-archive"></i> <?php echo $milestone['Milestone']['title']; ?></p>
				</a>
			<?php endforeach; ?>
		</div>
	</div>
